...
const Herosection = () => {
  return (
    <section className="w-full px-3 md:px-5 py-30 md:py-20 min-h-screen">
      <TopAnimator>
        <h1 className="uppercase font-chillax font-medium text-center md:text-[15vw] text-[22vw] xl:text-[219.03px] tracking-tighter xl:tracking-[-16.54px] xl:leading-[246.41px] mt-[2.424rem]">
          Case Studies
        </h1>
      </TopAnimator>
      <div className="hidden md:grid md:grid-cols-3 grid-rows-1 gap-5 mb-8 xl:w-[92vw] mx-auto my-0">
      ...
      <div className="border-2 rounded-2xl border-red-primary-400 overflow-hidden w-[92vw] mx-auto my-11.5 xl:h-[6.9vh]">
        <InfiniteSlider
          ...
          className="overflow-y-hidden pt-1"
        />
      </div>
    </section>
  );
