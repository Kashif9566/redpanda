...
const VisualIdentity = () => {
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="py-16 md:py-4 w-full flex flex-col">
        {/* Typography Section */}
        <div className="w-full flex flex-col justify-between mb-24">
          ...
          <div className="relative w-full flex items-center justify-center py-10 overflow-hidden">
            <div className="text-[12rem] md:text-[20rem] lg:text-[20.5rem] font-antonio font-bold text-[#101010] leading-[0.65] tracking-tighter w-full text-center select-none uppercase -mx-8">
              TYPOGRAPHY
            </div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#e5e5e5] px-6 md:px-12 py-2 md:py-4">
          ...
          {/* Typography Details */}
          <div className="w-full flex flex-col md:flex-row justify-between items-end mt-12 gap-12 font-manrope">
            {/* Weights */}
        ...
        {/* Colors Used Section */}
        <div className="border border-black border-2 w-full flex flex-col md:flex-row justify-between pt-16 border-t-2 border-[#101010]/10 gap-12 p-2">
          {/* Left: COLORS USED */}
          <div className="w-full md:w-5/12 flex flex-col">
            <h2 className="text-7xl md:text-9xl lg:text-[11rem] font-antonio font-bold text-[#101010] leading-[1] tracking-tighter uppercase mb-8">
              COLORS<br/>USED
            </h2>
          </div>

          {/* Right: Color Grid */}
          <div className="w-full md:w-7/12 grid grid-cols-2 gap-2">
