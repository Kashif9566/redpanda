const FooterSection = () => {
  return (
    <div className="w-full flex flex-col font-manrope">
      ...
      {/* PLAY Banner */}
      <div className="w-full bg-[#101010] min-h-[30vh] md:min-h-[80vh] flex items-end px-6 md:px-12 pb-6 md:pb-12 text-[#FAFAFA]">
      ...
      {/* Footer Content */}
      <div className="w-full bg-[#E2E2E2] flex flex-col md:flex-row items-center md:items-end justify-between relative overflow-hidden">
        
        {/* Left - Red Panda Network */}
        <div className="w-full md:w-5/12 flex items-center relative z-10">
          <h2 className="text-[6rem] md:text-[8rem] lg:text-[11.5rem] font-antonio font-bold text-[#A62226] uppercase leading-[0.9] tracking-tighter">
        ...
        {/* Right - Image block */}
        <div className="w-full md:w-[35%] bg-[#9A9A9A] flex items-center justify-center p-8 md:p-12 mt-10 min-h-[300px]">
          <img 
