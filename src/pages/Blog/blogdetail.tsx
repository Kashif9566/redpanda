  ...
  return (
    <HeaderFooterLayout>
      <section className="bg-background-white pt-30 px-4 min-h-screen">
        <div className="max-w-[1116px] mx-auto mb-10">
          ...
          {!loading && !error && blog && (
            <div className="flex flex-col gap-6 md:gap-10">
              ...
              <h1
                className="text-3xl md:text-[60px] font-chillax md:font-medium md:leading-[77px] md:tracking-[-2px] text-gray-900"
              ...
              <div className="prose prose-lg md:prose-xl max-w-none prose-headings:font-chillax prose-headings:font-bold prose-p:text-gray-700 prose-a:text-red-primary-400 prose-img:rounded-xl">
                <div 
                  className="font-chillax md:text-[24px] md:leading-[57px] md:tracking-[-2px]"
