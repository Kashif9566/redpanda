...
const Industries = () => {
    ...
    return (
        <div ref={sectionRef} className="bg-[#FFFFFF] w-full px-4 lg:px-5 py-12">
            <IndustryIntroText />
            <div className="flex justify-center items-center xl:w-[47vw]">
                <div className="flex gap-5 flex-col md:flex-row xl:w-[42.813vw]">
                    <div className="flex-1 flex-col md:flex-row flex gap-5">
                        <div className="flex flex-col flex-1 gap-5 overflow-hidden">
                            <Industrygraycard
                                containerClassName="h-[370px] md:h-[27vw] xl:h-[370px]  md:min-w-[318px] xl:min-w-[318px] xl:w-[318px] w-full p-5"
                                title="Crypto & Web3"
                                description="We help you navigate blockchain, NFTs, and the future of the internet."
                                imgsrc={cryptoandweb3image}
                                imgClassName="bottom-0 right-0 left-0 w-full xl:h-[211px]"
                            />
                            <Industryredcard containerClassName="h-[229px] md:h-[16.7vw] xl:h-[229px] xl:w-[318px] w-full pl-8 flex-col">
                                <img
                                    src={flyingarrowimg}
                        ...
                        <div className="flex-1 flex justify-between flex-col gap-2">
                            <Industryredcard containerClassName="h-[199px] md:h-[14.5vw] xl:h-[199px] xl:w-[318px] w-full overflow-hidden justify-start ">
                            ...
                            <Industrygraycard
                                containerClassName="h-[401px] md:h-[29.3vw] xl:h-[401px] xl:w-[318px] w-full p-5"
                                title="Packaging"
                                ...
                                imgClassName="bottom-0 right-0 left-0 w-full xl:w-[322.25px] xl:h-[258.19px]"
                            />
                        </div>
                    </div>
                    <div className="flex-1 flex flex-col gap-5">
                        <div className="flex flex-col md:flex-row gap-5">
                            <Industrygraycard
                                containerClassName="w-full md:min-w-[432px] xl:min-w-[432px] xl:w-[432px] h-[199px] md:h-[14.5vw] xl:h-[199px] flex p-5 flex-col"
                                title="Healthcare"
                            ...
                            />
                            <div className="w-full gsap-gray-card md:min-w-[204px] xl:min-w-[204px] xl:w-[204px] h-[199px] md:h-[14.5vw] xl:h-[199px] flex justify-center items-center rounded-[28px] bg-[#F0EEEE] relative overflow-hidden">
                                <img
                                    src={thankyoupanda}
                                    className="object-cover w-[85px] h-[63px] md:w-[6.2vw] md:h-[9.8vh] xl:w-[200px] xl:h-[205px] xl:absolute xl:bottom-[-37px]"
                                    width={85}
                                    height={63}
                                    alt="Loading..."
                        ...
                        <div className="flex flex-col md:flex-row gap-5">
                            <Industryredcard
                                containerClassName="h-[229px] md:h-[16.7vw] xl:h-[229px] w-full md:min-w-[318px] xl:min-w-[318px] xl:w-[318px] p-5 items-stretch justify-stretch"
                            >
                                <Industryredcardheading
                                    text={
                                        <>
                            ...
                            <Industrygraycard
                                containerClassName="w-full min-w-[318px] xl:min-w-[318px] xl:w-[318px] h-[229px] md:h-[16.7vw] xl:h-[229px] px-5 py-7"
                                title="Logistic"
                        ...
                        <div className=" bg-red-primary-400 gsap-red-card h-[147px] md:h-[10.7vw] xl:h-[147px] rounded-[28px] flex items-center overflow-hidden gap-4 w-full md:max-w-[50vw] xl:w-[662px] xl:max-w-none">
                            <InfiniteSlider
