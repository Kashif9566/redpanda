...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex gap-10 md:flex-row flex-col-reverse justify-around items-center md:mt-[var(--header-h)]!"
        style={{
      ...
      >
        ...
        <div className="w-full h-full flex flex-col gap-[20.23px] 2xl:mt-[30px] xl:mt-14 xl:w-[37.93rem] xl:h-[33.09rem]">
        ...
        <div
          className="hidden md:flex relative flex-col justify-end items-center w-full h-[600px] md:h-auto xl:w-[37.19rem] xl:h-151"
        ...
        >
              ...
              <div className="w-full md:w-[45vw] h-[360px] relative flex items-center justify-center">
                {activeImages.map((imgSrc, index) => (
                  <img
                    ...
                    className="absolute w-[70%] max-w-[420px] h-[450px] min-[1600px]:h-auto rounded-[24px] xl:w-[19.759rem] xl:h-[26.975rem] xl:rounded-[0.572rem]"
                    style={{
                      transform:
                        index === 0
          ...
          >
            <p className="font-chillax text-white font-light text-[16px] xl:text-[1.153rem] md:text-[1.15vw] leading-[24px] md:leading-[1.6vw]">
