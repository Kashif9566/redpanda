...
const Herosection = () => {
    ...
    return (
        <section className="w-full flex flex-col md:flex-row items-start pt-30 px-6 bg-background-white gap-20">
            <div className="h-full w-full md:w-[45%] md:mt-[140px]">
                <Sectionheading
                    className="md:leading-[100px] md:tracking-[-5.45px]"
                    heading={
                        <>
                            Book a{" "}
                ...
                />
                <p className="font-chillax font-[400] md:text-[24px] md:leading-[37px] md:tracking-[-1px] md:max-w-[65%] mt-4">Dedicated Design & Strategy Support To give boost to Every Digital Product.</p>
            </div>
