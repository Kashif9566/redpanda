...
const IndustryIntroText = () => {
    ...
    return (
        <h1 ref={textRef} className="font-chillax font-[400] text-[28px] md:text-[2.7vw] xl:text-[37.5px] leading-[57px] md:leading-[4.1vw] xl:leading-[57px] tracking-[-2px] mb-8" >We partner with a diverse range of industries, delivering tailored solutions that drive growth and innovation. Our expertise spans various sectors, helping businesses thrive in a rapidly evolving landscape.</h1>
    )
}
