...
const Industrygraycard = ({ title, description, containerClassName, headingClassName, descClassName, imgClassName, imgsrc }: IndustryGrayCardProps) => {
    return <div className={cn("bg-[#F0EEEE] gsap-gray-card rounded-[28px] relative overflow-hidden isolate", containerClassName)}>
        <h1 className={cn("text-bg-black-100 text-[24px] xl:text-[24px] leading-[38px] xl:leading-[38.4px] md:text-[1.75vw] md:leading-[2.78vw] mb-2 tracking-[-2px] font-chillax font-medium", headingClassName)}>{title}</h1>
        <p className={cn("font-chillax font-[400] text-[15px] xl:text-[15px] leading-[25px] xl:leading-[25px] md:text-[1vw] md:leading-[1.83vw] tracking-[0px] ", descClassName)}>{description}</p>
