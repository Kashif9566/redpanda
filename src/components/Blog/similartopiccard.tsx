...
const SimilarTopicCard = ({ id, title, category, image }: SimilarTopicCardProps) => {
    ...
    return (
        <div
            ...
            className="flex-shrink-0 flex flex-col gap-6 cursor-pointer group w-[300px] md:w-[544px] md:h-[701px]"
        >
            ...
            <div className="flex flex-col gap-2">
                <div className="flex justify-between items-start">
                    ...
                    <div className="md:w-[65px] md:h-[65px] w-12 h-12 flex-shrink-0 rounded-full bg-red-primary-400 flex items-center justify-center mt-4 group-hover:bg-red-500 transition-colors">
                        <ArrowUpRight color="white" className="w-6 h-6 md:w-[39px] md:h-[39px]" />
                    </div>
                </div>
            </div>
        </div>
