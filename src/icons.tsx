...
export function SaasdesignIcon({
  ...
  const vars = {
    ...
    "--arrow-hover-deg": `${arrowHoverDeg}deg`,
    "--nut-hover-deg": `${nutHoverDeg}deg`,
  } as React.CSSProperties & { [key: string]: string | number };
  ...
  return (
    ...
    >
      <rect
        ...
        height="44"
        rx="6"
        fill={THEME_STYLES.Colors.starburst[useSiteTheme()]}
      />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
...
export const InteractiveChipsButtonIcon = ({
  ...
  const fill = THEME_STYLES.Colors.blueStarburst[theme];
  ...
  return (
    <svg
      ...
      {...props}
    >
      <rect width="181" height="64" rx="32" fill={fill} />
...
export const BadgesDiamondIcon = ({
  ...
  const theme = useSiteTheme();
  const strokeColor = theme === "landing" ? "#FAFAFA" : "#000000";

  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width ?? "13"} height={height ?? "13"} viewBox="0 0 13 13" fill="none" {...props}>
      <path d="M6.30566 0.21582C6.73004 0.211576 7.15147 0.291111 7.54492 0.450195C7.88918 0.589399 8.20608 0.787318 8.48242 1.03418L8.59863 1.14258L11.791 4.33887V4.33984C12.089 4.64301 12.3244 5.00187 12.4824 5.39648C12.6405 5.79114 12.7183 6.2136 12.7119 6.63867C12.7055 7.06369 12.6151 7.48336 12.4453 7.87305C12.2755 8.26278 12.0296 8.61506 11.7227 8.90918L8.87695 11.7549C8.27945 12.3605 7.46594 12.7047 6.61523 12.7119C5.7644 12.719 4.94457 12.3886 4.33691 11.793L1.13965 8.59961C0.842781 8.29752 0.608773 7.93963 0.450195 7.54688C0.29139 7.15341 0.211578 6.7319 0.21582 6.30762C0.220101 5.88344 0.308008 5.46433 0.474609 5.07422C0.64122 4.68408 0.883049 4.3306 1.18652 4.03418L4.03223 1.18848C4.32838 0.884485 4.68207 0.641531 5.07227 0.474609C5.46229 0.307805 5.8815 0.220104 6.30566 0.21582Z" stroke={strokeColor} strokeWidth={strokewidth ?? "0.430923"} />
    </svg>
  );
};
...
export const StarburstIcon = ({ height, width, color = "#EA2227", ...props }: IconProps) => {
  return (
    <svg
      width={width ?? 51}
      height={height ?? 52}
      ...
      {...props}
    >
      <rect x="22" y="0.5" width="7" height="51" fill={color} />
      <rect
        x="36"
        y="2.5"
        width="7"
